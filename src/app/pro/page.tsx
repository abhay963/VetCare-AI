            ...
            <div className="space-y-4">
              ...
              <div>
                <h1 className="text-4xl font-bold mb-2">
                  Unlock Premium VetCare AI
                </h1>
                <p className="text-muted-foreground">
                  Get unlimited AI-powered animal health analysis, instant vet access, and advanced
                  care tools to keep your animals healthy and safe.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Select the perfect plan for your animal care needs. All plans include secure access,
              real-time AI support, and reliable veterinary assistance.
            </p>
          </div>
