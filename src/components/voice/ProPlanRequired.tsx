              ...
              <div className="space-y-4">
                ...
                <div>
                  <h1 className="text-4xl font-bold mb-2">
                    Voice Vet Assistant Access Required
                  </h1>
                  <p className="text-muted-foreground">
                    Upgrade to AI Basic or AI Pro to unlock voice-based animal health consultations
                    with VetCare AI and get instant guidance for your livestock and pets.
                  </p>
                </div>
              </div>
        ...
        <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30 max-w-2xl mx-auto">
          <CardContent className="relative p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              The voice assistant feature is available in AI Basic and AI Pro plans. Talk to our
              AI-powered veterinary assistant and get real-time guidance for animal health issues.
            </p>

            <div className="space-y-4 mb-6">
              <div className="flex items-center gap-3 justify-center">
                <div className="w-2 h-2 bg-primary rounded-full"></div>
                <span className="text-sm">24/7 AI voice consultations for animals</span>
              </div>
              <div className="flex items-center gap-3 justify-center">
                <div className="w-2 h-2 bg-primary rounded-full"></div>
                <span className="text-sm">Instant disease guidance & treatment suggestions</span>
              </div>
              <div className="flex items-center gap-3 justify-center">
                <div className="w-2 h-2 bg-primary rounded-full"></div>
                <span className="text-sm">Emergency advice for livestock & pets</span>
              </div>
            </div>
